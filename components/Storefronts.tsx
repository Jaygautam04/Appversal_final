      ...
      >
        <header className="flex items-center justify-between py-3 px-4 border-b border-gray-200">
          ...
          <div className="flex items-center space-x-2 text-gray-500">
            <button className="p-1 hover:text-gray-700 text-teal-500">
              <GlobeIcon />
            </button>
        ...
        >
          ...
          <div
            className="relative w-full h-64 overflow-hidden cursor-grab active:cursor-grabbing"
          ...
          >
            <svg viewBox="0 0 1000 470" className="w-full h-full" preserveAspectRatio="xMidYMid meet">
              ...
              >
                ...
                >
                  ...
                  <path
                    data-name="Mexico"
                    d="m233.3 218.4-12.5-1.9-10.3.3-6.8-2.1-3.5-5.1-1.5-6.4 1.5-5.7-6.2-4.1-8.7-1-11.9 2.9-9.2 1.3-8.3-1.9-6.6-2.9-4.1-6.6-1.9-7.3-.3-2.9-6.2-1.9-4.3-4.1-1.9 5.7 3.2 8.3 5.3 6.6 9.4 3.2 10.3 1.5 11.2 3.3 8.7 5.1 6.2 6.6 3.6 7.6h7.1l6.2-2.9z"
                  />
                  <path
                    data-name="Greenland"
                    fill="#E5E7EB"
                    d="m358.1 28.6-11.2.3-9.4 2.9-11.2 3.6-8.1 4.8-6.8 6.8-5.1 8.5-3.3 9.4-1.5 11.2.3 11.2 1.9 9.4 3.6 8.1 5.3 6.8 7.3 5.1 9 3.3 10.3 1.5 11.2-.3 10.8-2.1 9.4-4.1 8.1-6 6.8-8.1 5.1-9.9 3.3-11.2 1.5-11.9-1.9-6-5.1-4.8-11.2-1.5-13.8.3-11.9 3.3-9.4 5.1-7.3 6.8-5.3z"
                  />
                  <path
                    data-name="Iceland"
                    d="m382.9 84.1-4.8 1.9-3.8 3.5-2.6 4.8-1.5 5.7.3 5.7 1.5 4.8 2.6 3.8 3.8 2.6 4.8 1.5 5.7-.3 4.8-1.5 3.8-2.6 2.6-3.8 1.5-4.8-.3-5.7-1.5-4.8-2.6-3.8-3.8-2.6z"
                  />
                  <path
                    data-name="Brazil"
                    d="m355.9 270.3-4.8 5.7-11.9 7.1-10.8 4.8-11.9 2.1-12.8-.3-12.1-2.4-11.4-4.5-10.3-6.6-9-8.7-7.6-10.8-6-12.8-4.3-14.7-2.4-16.3-.5-17.2 1.5-16.3 3.5-14.7 5.7-12.8 7.6-11 9.4-8.7 11.4-6.8 13-4.8 14.5-2.6 15.8-.5 16.9 1.9 15.8 4.1 14.5 6 13 7.6 11.2 9 9.4 10.3 7.6 11.2 6 11.9 4.5 12.5 2.6 12.8.5 13-1.9z"
                  />
                  <path
                    data-name="Argentina"
                    d="m343.3 358.4-12.8-.5-12.5-2.6-11.9-4.5-11.2-6-10.3-7.6-9.4-9-8.1-10.3-6.8-11.2-5.3-12.1-3.6-12.8-1.9-13.2.5-13.2 2.6-12.8 4.8-12.1 6.8-11.2 8.7-9.9 10.3-8.3 11.9-6.6 13.2-4.5 14.5-2.4 15.5-.3 16.3 1.9 15.5 4.1 14.5 6 13.2 7.6 11.9 9 10.3 10.3 8.7 11.2 7.1 11.9 5.7 12.5 4.1 12.8 2.4 13 .5z"
                  />
                  <path
                    data-name="Russia"
                    d="m555.3 120.4-11.9-2.1-12.8.3-11.9 2.4-11 4.5-9.9 6.6-8.7 8.7-7.3 10.8-5.7 12.8-4.1 14.7-2.4 16.3-.3 17.2 1.5 16.3 3.5 14.7 5.7 12.8 7.6 11 9.4 8.7 11.4 6.8 13 4.8 14.5 2.6 15.8.5 16.9-1.9 15.8-4.1 14.5-6 13-7.6 11.2-9 9.4-10.3 7.6-11.2 6-11.9 4.5-12.5 2.6-12.8-.5-13 1.9-12.8 4.1-12.1 6-11.2 7.6-9.9 9-8.7 10.3-7.1 11.4-5.7 12.5-4.1 13.2-2.4 13.8-.3 14.1 1.9 13.8 4.1 13.2 6 12.5 7.6 11.9 9 11.2 9.9 10.3 8.7 11.2 7.3 11.9 6 12.5 4.8 12.8 3.3 13.2 1.9 13.2-.3 13.2 1.5-12.8 3.3-12.5 4.8-11.9 6-11.2 7.3-10.3 8.7-9.4 9.9-8.3 11.2-7.1 11.9-5.7 12.8-4.3 13.2-2.6 13.8-.5z"
                  />
                  <path
                    data-name="China"
                    d="m640.4 200.4-11.2-7.3-11.9-6-12.5-4.8-12.8-3.3-13.2-1.9-13.2-.3-13.2 1.5-12.8 3.3-12.5 4.8-11.9 6-11.2 7.3-10.3 8.7-9.4 9.9-8.3 11.2-7.1 11.9-5.7 12.8-4.3 13.2-2.6 13.8-.5 14.1 1.9 13.8 4.1 13.2 6 12.5 7.6 11.9 9 11.2 9.9 10.3 8.7 11.2 7.3 11.9 6 12.5 4.8 12.8 3.3 13.2 1.9 13.2.3 13.2-1.5 12.8-3.3 12.5-4.8 11.9-6 11.2-7.3 10.3-8.7 9.4-9.9 8.3-11.2 7.1-11.9 5.7-12.8 4.3-13.2 2.6-13.8.5z"
                  />
                  <path
                    fill="#D97706"
                    data-name="India"
                    d="m622.1 262.2-4.1-13.8-.5-14.1 1.9-13.8 4.1-13.2 6-12.5 7.6-11.9 9-11.2 9.9-10.3 8.7-11.2 7.3-11.9 6-12.5 4.8-12.8 3.3-13.2 1.9-13.2.3-13.2-1.5-12.8-3.3-12.5-4.8-11.9-6-11.2-7.3-10.3-8.7-9.4-9.9-8.3-11.2-7.1-11.9-5.7-12.8-4.3-13.2-2.6-13.8-.5z"
                  />
                  <path
                    data-name="Australia"
                    d="m761.6 345.9-12.8-4.3-13.2-2.6-13.8-.5-14.1 1.9-13.8 4.1-13.2 6-12.5 7.6-11.9 9-11.2 9.9-10.3 8.7-11.2-7.3-11.9-6-12.5-4.8-12.8-3.3-13.2-1.9-13.2-.3-13.2 1.5-12.8 3.3-12.5 4.8-11.9 6-11.2 7.3-10.3 8.7-9.4 9.9-8.3 11.2-7.1 11.9-5.7 12.8-4.3 13.2-2.6 13.8-.5 14.1 1.9 13.8 4.1 13.2 6 12.5 7.6 11.9 9 11.2 9.9 10.3 8.7 11.2 7.3 11.9 6 12.5 4.8 12.8 3.3 13.2 1.9 13.2.3z"
                  />
                  <path
                    data-name="Africa"
                    d="m424.1 200.4-11.2-7.3-11.9-6-12.5-4.8-12.8-3.3-13.2-1.9-13.2-.3-13.2 1.5-12.8 3.3-12.5 4.8-11.9 6-11.2 7.3-10.3 8.7-9.4 9.9-8.3 11.2-7.1 11.9-5.7 12.8-4.3 13.2-2.6 13.8-.5 14.1 1.9 13.8 4.1 13.2 6 12.5 7.6 11.9 9 11.2 9.9 10.3 8.7 11.2 7.3 11.9 6 12.5 4.8 12.8 3.3 13.2 1.9 13.2.3 13.2-1.5 12.8-3.3 12.5-4.8 11.9-6 11.2-7.3 10.3-8.7 9.4-9.9 8.3-11.2 7.1-11.9 5.7-12.8 4.3-13.2 2.6-13.8.5z"
                  />
                </g>
              </g>
            </svg>
            ...
            <div className="absolute bottom-4 left-4 flex flex-col space-y-1">
              <button
                ...
                className="bg-white p-1 rounded-sm shadow border text-gray-600 hover:bg-gray-100"
              >
                <PlusIcon />
              </button>
              <button
